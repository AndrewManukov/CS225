...
/tmp/tmp-20334inX6S4zU3FqV/tests/tests-part1.cpp:109: undefined reference to `cs225::Image::scale(double)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____16()':
/tmp/tmp-20334inX6S4zU3FqV/tests/tests-part1.cpp:118: undefined reference to `cs225::Image::scale(double)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____18()':
/tmp/tmp-20334inX6S4zU3FqV/tests/tests-part1.cpp:127: undefined reference to `cs225::Image::scale(double)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____20()':
/tmp/tmp-20334inX6S4zU3FqV/tests/tests-part1.cpp:137: undefined reference to `cs225::Image::scale(double)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____22()':
/tmp/tmp-20334inX6S4zU3FqV/tests/tests-part1.cpp:147: undefined reference to `cs225::Image::scale(unsigned int, unsigned int)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____25()':
/tmp/tmp-20334inX6S4zU3FqV/tests/tests-part1.cpp:159: undefined reference to `cs225::Image::scale(unsigned int, unsigned int)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____28()':
/tmp/tmp-20334inX6S4zU3FqV/tests/tests-part1.cpp:171: undefined reference to `cs225::Image::scale(unsigned int, unsigned int)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____31()':
/tmp/tmp-20334inX6S4zU3FqV/tests/tests-part1.cpp:183: undefined reference to `cs225::Image::scale(unsigned int, unsigned int)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____34()':
/tmp/tmp-20334inX6S4zU3FqV/tests/tests-part1.cpp:195: undefined reference to `cs225::Image::scale(unsigned int, unsigned int)'
.objs/tests/tests-part1.o:/tmp/tmp-20334inX6S4zU3FqV/tests/tests-part1.cpp:205: more undefined references to `cs225::Image::scale(unsigned int, unsigned int)' follow
...
This report was generated for **manukov2** using **c762d2635eb6cb59317bac766c018b123191f2e6** (from **September 18th 2019, 12:15:00 am**)
