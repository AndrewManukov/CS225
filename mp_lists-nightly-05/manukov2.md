...
==4292== Command: ./test -r xml "List::insertFront\ size"
==4292== 
==4292== Conditional jump or move depends on uninitialised value(s)
==4292==    at 0x435DDC: List<int>::insertFront(int const&) (List.hpp:55)
==4292==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==4292==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==4292==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==4292==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==4292==    by 0x45F416: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==4292==    by 0x45D9EE: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==4292==    by 0x466D86: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==4292==    by 0x465A22: Catch::Session::runInternal() (catch.hpp:10149)
==4292==    by 0x4656EA: Catch::Session::run() (catch.hpp:10106)
==4292==    by 0x465669: Catch::Session::run(int, char**) (catch.hpp:10074)
==4292==    by 0x4926E1: main (catch.hpp:13613)
==4292== 
==4292== Conditional jump or move depends on uninitialised value(s)
==4292==    at 0x435E16: List<int>::insertFront(int const&) (List.hpp:58)
==4292==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==4292==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==4292==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==4292==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==4292== 
==4292== Conditional jump or move depends on uninitialised value(s)
==4292==    at 0x463030: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==4292==    by 0x440F0B: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==4292==    by 0x4303B4: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==4292==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==4292==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==4292==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==4292==    by 0x45F416: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==4292== 
==4292== HEAP SUMMARY:
==4292==     in use at exit: 240 bytes in 10 blocks
==4292==   total heap usage: 2,328 allocs, 2,318 frees, 267,368 bytes allocated
==4292== 
==4292== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==4292==    at 0x4C29BE3: malloc (vg_replace_malloc.c:299)
==4292==    by 0x4E5A9C4: operator new(unsigned long) (in /clang+llvm-6.0.1-x86_64-linux-sles11.3/lib/libc++abi.so.1.0)
==4292==    by 0x435D93: List<int>::insertFront(int const&) (List.hpp:51)
==4292==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==4292==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==4292==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==4292==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==4292== 
==4292== LEAK SUMMARY:
==4292==    definitely lost: 240 bytes in 10 blocks
==4292==    indirectly lost: 0 bytes in 0 blocks
==4292==      possibly lost: 0 bytes in 0 blocks
==4292==    still reachable: 0 bytes in 0 blocks
...
==4292== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
==4307== Command: ./test -r xml "List::_destroy\ empty\ list"
==4307== 
==4307== 
==4307== HEAP SUMMARY:
==4307==     in use at exit: 0 bytes in 0 blocks
==4307==   total heap usage: 2,336 allocs, 2,336 frees, 268,200 bytes allocated
==4307== 
==4307== All heap blocks were freed -- no leaks are possible
==4307== 
==4307== For counts of detected and suppressed errors, rerun with: -v
==4307== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from 0)
