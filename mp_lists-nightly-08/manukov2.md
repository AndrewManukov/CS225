...
```
==19378== Memcheck, a memory error detector
==19378== Copyright (C) 2002-2015, and GNU GPL'd, by Julian Seward et al.
==19378== Using Valgrind-3.11.0 and LibVEX; rerun with -h for copyright info
==19378== Command: ./test -r xml "List::insertFront\ size"
==19378== 
==19378== Conditional jump or move depends on uninitialised value(s)
==19378==    at 0x435DDC: List<int>::insertFront(int const&) (List.hpp:55)
==19378==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==19378==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==19378==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==19378==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==19378==    by 0x45F416: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==19378==    by 0x45D9EE: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==19378==    by 0x466D86: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==19378==    by 0x465A22: Catch::Session::runInternal() (catch.hpp:10149)
==19378==    by 0x4656EA: Catch::Session::run() (catch.hpp:10106)
==19378==    by 0x465669: Catch::Session::run(int, char**) (catch.hpp:10074)
==19378==    by 0x4926E1: main (catch.hpp:13613)
==19378== 
==19378== Conditional jump or move depends on uninitialised value(s)
==19378==    at 0x435E16: List<int>::insertFront(int const&) (List.hpp:58)
==19378==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==19378==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==19378==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==19378==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==19378== 
==19378== Conditional jump or move depends on uninitialised value(s)
==19378==    at 0x463030: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==19378==    by 0x440F0B: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==19378==    by 0x4303B4: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==19378==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==19378==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==19378==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==19378==    by 0x45F416: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==19378== 
==19378== HEAP SUMMARY:
==19378==     in use at exit: 240 bytes in 10 blocks
==19378==   total heap usage: 2,328 allocs, 2,318 frees, 267,368 bytes allocated
==19378== 
==19378== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==19378==    at 0x4C29BE3: malloc (vg_replace_malloc.c:299)
==19378==    by 0x4E5A9C4: operator new(unsigned long) (in /clang+llvm-6.0.1-x86_64-linux-sles11.3/lib/libc++abi.so.1.0)
==19378==    by 0x435D93: List<int>::insertFront(int const&) (List.hpp:51)
==19378==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==19378==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==19378==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==19378==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==19378== 
==19378== LEAK SUMMARY:
==19378==    definitely lost: 240 bytes in 10 blocks
==19378==    indirectly lost: 0 bytes in 0 blocks
==19378==      possibly lost: 0 bytes in 0 blocks
==19378==    still reachable: 0 bytes in 0 blocks
==19378==         suppressed: 0 bytes in 0 blocks
==19378== 
==19378== For counts of detected and suppressed errors, rerun with: -v
==19378== Use --track-origins=yes to see where uninitialised values come from
==19378== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
==19393== Copyright (C) 2002-2015, and GNU GPL'd, by Julian Seward et al.
==19393== Using Valgrind-3.11.0 and LibVEX; rerun with -h for copyright info
==19393== Command: ./test -r xml "List::_destroy\ empty\ list"
==19393== 
==19393== 
==19393== HEAP SUMMARY:
==19393==     in use at exit: 0 bytes in 0 blocks
==19393==   total heap usage: 2,336 allocs, 2,336 frees, 268,200 bytes allocated
==19393== 
