...
/tmp/tmp-9586wxelTkvGsFYA/tests/tests-part1.cpp:109: undefined reference to `cs225::Image::scale(double)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____16()':
/tmp/tmp-9586wxelTkvGsFYA/tests/tests-part1.cpp:118: undefined reference to `cs225::Image::scale(double)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____18()':
/tmp/tmp-9586wxelTkvGsFYA/tests/tests-part1.cpp:127: undefined reference to `cs225::Image::scale(double)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____20()':
/tmp/tmp-9586wxelTkvGsFYA/tests/tests-part1.cpp:137: undefined reference to `cs225::Image::scale(double)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____22()':
/tmp/tmp-9586wxelTkvGsFYA/tests/tests-part1.cpp:147: undefined reference to `cs225::Image::scale(unsigned int, unsigned int)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____25()':
/tmp/tmp-9586wxelTkvGsFYA/tests/tests-part1.cpp:159: undefined reference to `cs225::Image::scale(unsigned int, unsigned int)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____28()':
/tmp/tmp-9586wxelTkvGsFYA/tests/tests-part1.cpp:171: undefined reference to `cs225::Image::scale(unsigned int, unsigned int)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____31()':
/tmp/tmp-9586wxelTkvGsFYA/tests/tests-part1.cpp:183: undefined reference to `cs225::Image::scale(unsigned int, unsigned int)'
.objs/tests/tests-part1.o: In function `____C_A_T_C_H____T_E_S_T____34()':
/tmp/tmp-9586wxelTkvGsFYA/tests/tests-part1.cpp:195: undefined reference to `cs225::Image::scale(unsigned int, unsigned int)'
.objs/tests/tests-part1.o:/tmp/tmp-9586wxelTkvGsFYA/tests/tests-part1.cpp:205: more undefined references to `cs225::Image::scale(unsigned int, unsigned int)' follow
